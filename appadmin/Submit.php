...
<head>
    ...
    <!-- jQuery (necessary for JavaScript to work) -->
    ...
    <style>
        ...
        /* Additional CSS for delete button and file display */
.journal-entry {
    margin-bottom: 20px;
}
...
<body>
                ...
                <div id="content">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end">
                            <button class="bbutt" data-bs-toggle="modal" data-bs-target="#journalModal">Add Journal</button>
                        </div>
                    </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div id="submittedEntries" class="no-submissions">No submissions found.</div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="journalModalLabel">Add Journal</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="addJournalForm" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="journalTitle" class="form-label">Journal Name</label>
                            <input type="text" class="form-control" id="journalTitle" name="title" required>
                        </div>
                        <div class="mb-3">
                            <label for="journalAuthor" class="form-label">Author</label>
                            <input type="text" class="form-control" id="journalAuthor" name="author" required>
                        </div>
                        <div class="mb-3">
                            <label for="journalDescription" class="form-label">Description</label>
                            <input type="text" class="form-control" id="journalDescription" name="description" required>
                        </div>
                        <div class="mb-3">
                            <label for="journalFile" class="form-label">Upload File</label>
                            <input type="file" class="form-control" id="journalFile" name="file" required>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            function loadSubmittedEntries() {
                $("#submittedEntries").load("../phptools/load_submitted_entries.php");
            }
            ...
            $("#addJournalForm").submit(function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../phptools/submit_journal.php",
                    data: formData,
                    processData: false,
                    contentType: false,
    ...
    $('.delete-btn').click(function() {
        ...
        if (confirm("Are you sure you want to delete this journal entry?")) {
            $.ajax({
                type: "POST",
                url: "../phptools/delete_journal.php",
                data: { id: journalId },
                success: function(response) {
                    alert(response);
                    // Reload or update journal entries after deletion
